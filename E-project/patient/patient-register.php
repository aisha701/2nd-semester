...
if(isset($_POST['signup'])){
    ...
    $encrypedPassword = password_hash($p_password, PASSWORD_BCRYPT);
    ...
    if(mysqli_num_rows($res) > 0){
        ...
        $insert = "INSERT INTO `patients`(`p_name`, `p_email`, `p_Password`) VALUES ('$p_name','$p_email','$encrypedPassword');";
        $result = mysqli_query($connection, $insert) or die("failed to insert query.");
        if($result){ 
			$_SESSION['PatientID'] = mysqli_insert_id($connection);
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        ...
                        window.location.href='patient-details.php';
                    });
                });
            </script>";
        }
								...
								<div class="col-md-12 col-lg-6 login-right">
									...
									<form action="" method="post">
										<div class="form-group form-focus">
											<input type="text" class="form-control floating" name="p_name">
											<label class="focus-label">Name</label>
										</div>
										<div class="form-group form-focus">
											<input type="text" class="form-control floating" name="p_email">
										...
										<button class="btn btn-primary btn-block btn-lg login-btn"
											type="submit" name="signup">signup</button>
