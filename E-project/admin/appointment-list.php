    ...
    while ($appointments = mysqli_fetch_assoc($appointments_run)) {
		...
		echo'
												...
												<tr>
													...
													<td>
													<a class="btn badge badge-pill btn-success text-light" href="updateapptstatus.php?apt_id='.$AppointmentID.'&action=Confirmed">Confirm </a>
													<br>
													<a class="btn badge badge-pill btn-danger text-light" href="updateapptstatus.php?apt_id='.$AppointmentID.'&action=Cancelled"> &nbsp; Cancel  &nbsp;</a>
